...
public class ProjectDescriptionDetailFragment extends Fragment {
    View view;
    ...
    TextView product_name,price_project,project_offers,businesstype_b2b,b2b_category,b2b_industries,
     ...
     LinearLayout b2b_linear, b2c_linear, sales_criteria_linear,lead_criteria_linear,SalesCommission_layout,LeadCommission_layout,Expected_Sales_linear,Expected_Lead_linear,
                    mcm_criteria_linear,sm_linear,  product_link_linear,training_linear;
    ...
    long mLastClickTime12 =0;
    private long mLastClickTime13 = 0;

    SwipeRefreshLayout swiperefresh_desc1;

    LinearLayout desc1_full;


    public ProjectDescriptionDetailFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_description1, container, false);
        initViews();
    ...
    {
        desc1_full = view.findViewById(R.id.desc1_full);
        ...
        desc_apply = view.findViewById(R.id.desc_apply);
        Application_form = view.findViewById(R.id.Application_form);
        swiperefresh_desc1 = view.findViewById(R.id.swiperefresh_desc1);
    ...
    private void initFunctionality()
    {
        ...
        desc_apply.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {


                if (SystemClock.elapsedRealtime() - mLastClickTime12 < 1000) {
                    return;
                }
                mLastClickTime12 = SystemClock.elapsedRealtime();
        ...
        ImageView share_image_desc1 = view.findViewById(R.id.share_image_desc1);

        share_image_desc1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                        ...
                        if(arraysalestype.length() == 1) {
                            ...
                            if (type.equalsIgnoreCase("sale")) {
                                ...
                                ShareData.shareItem(getActivity(), jsonObject1.getString("logo_url"), "\n\n"
                                        + product_name.getText().toString() + "\n" + head_project.getText().toString()
                                        + "\nPrice of product: " + price_project.getText().toString() + "\nCommission: " + sales_Commission.getText().toString()
                                        + "\n\nViews: " + jsonObject1.getString("views") + "\nActive Salesmen: " + project_no_salesman.getText().toString()
                                        + "\nTotal Incentive Earned: " + total_incentive.getText().toString() + "\nNature of project: " + type
                                ...
                                ShareData.shareItem(getActivity(), jsonObject1.getString("logo_url"), "\n\n"
                                        + product_name.getText().toString() + "\n" + head_project.getText().toString()
                                        + "\nPrice of product: " + price_project.getText().toString() + "\nCommission: " + lead_Commission.getText().toString()
                                        + "\n\nViews: " + jsonObject1.getString("views") + "\nActive Salesmen: " + project_no_salesman.getText().toString()
                                        + "\nTotal Incentive Earned: " + total_incentive.getText().toString() + "\nNature of project: " + type
                                        + "\n\nTo install the AOB Salesman App click the link below & get \u20B9 500 as registration bonus.\n"
                                        + "https://play.google.com/store/apps/details?id=" + appPackageName
                            ...
                            ShareData.shareItem(getActivity(), jsonObject1.getString("logo_url"), "\n\n"
                                    + product_name.getText().toString() + "\n" + head_project.getText().toString()
                                    + "\nPrice of product: " + price_project.getText().toString()+ "\nCommission Sale: " + sales_Commission.getText().toString() + "\nCommission Lead: " + lead_Commission.getText().toString()
                                    + "\n\nViews: " + jsonObject1.getString("views") + "\nActive Salesmen: " + project_no_salesman.getText().toString()
                                    + "\nTotal Incentive Earned: " + total_incentive.getText().toString() + "\nNature of project: " + type
                                    + "\n\nTo install the AOB Salesman App click the link below & get \u20B9 500 as registration bonus.\n"
                                    + "https://play.google.com/store/apps/details?id=" + appPackageName
        ...
        swiperefresh_desc1.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
    ...
    private void getProject(){
       ...
       // progressDialog.show();
        ...
        desc1_full.setVisibility(View.GONE);
        swiperefresh_desc1.setRefreshing(true);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success.equals("0")){
                                ...
                                final JSONArray jsonArrayall = jsonObject.getJSONArray("data");
...
*/
                            ...
                            )
                            {
                                ...
                                sm_linear.setVisibility(View.GONE);
                                    ...
                                    if (!TextUtils.isEmpty(jsonObject1.getString("ppt"))
                                        ...
                                        ppt.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                intent.putExtras(bundle);
                                                startActivity(intent);
                                               // startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(link6)));
                                            }
                                        });
                                    ...
                                    if(project_status.getText().toString().equalsIgnoreCase("active"))
                                    {
                                        desc_apply.setEnabled(true);
                                        desc_apply.setText("Apply");

                                    }else
                                    {
                                        desc_apply.setEnabled(false);
                                        desc_apply.setText("Project Closed");
                                    }
                            ...
                            desc1_full.setVisibility(View.VISIBLE);
                        ...
                        swiperefresh_desc1.setRefreshing(false);
