...
import com.ceodelhi.filesystemapp.activities.SearchFileFullScreen;
...
public class SearchFileAdapter extends RecyclerView.Adapter<SearchFileAdapter.MyViewHolder> {

    private Context mContext;
    private ArrayList<ModelFiles> files;


    public SearchFileAdapter(ArrayList<ModelFiles> files, Context mContext) {
        this.files = files;
...
//                .into(holder.imageView);
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                origin.startActivity(new Intent(mContext, SearchFileFullScreen.class).putExtra("file", file)
