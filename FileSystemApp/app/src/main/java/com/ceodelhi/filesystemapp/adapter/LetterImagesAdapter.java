...
public class LetterImagesAdapter extends RecyclerView.Adapter<LetterImagesAdapter.MyViewHolder> {

    private Context mContext;
    private ArrayList<String> fileImages;


    public LetterImagesAdapter(ArrayList<String> fileImages, Context mContext) {
...
//        Picasso.get().load(fileImage).placeholder(R.mipmap.home_page3)
//                .error(R.drawable.error)
//                .into(holder.singleImageView);

        Glide.with(mContext).asBitmap().load(fileImage)
