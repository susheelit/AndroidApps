...
public class LocationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements SwipeItemTouchHelper.SwipeHelperAdapter {
    ...
    public LocationAdapter(Context context, List<Social> items) {
        this.items = items;
        ctx = context;
    }
